...
const CvHeader = () => {
  return (
    <div className="flex flex-col gap-3 h-full  text-black justify-center items-center mb-3">
      ...
      <div className="flex sm:flex-row flex-col sm:gap-2 gap-0 items-center justify-center sm:text-2xl text-lg">
        <div className="flex items-center justify-center gap-1">
          <AiOutlineMail size={20} className="mt-1" />
          <p className="text-sm">FrancescoLutfi10@gmail.com</p>
        </div>
        <div className="flex items-center justify-center gap-1">
          <AiOutlineWhatsApp size={20} className="mt-1" />
          <p className="text-sm">087856524677</p>
        </div>
        <div className="flex items-center justify-center gap-1">
          <TbBrandTelegram size={20} className="mt-1" />
          <p className="text-sm">087754786544</p>
        </div>
      </div>
    </div>
  );
