...
const GetStarted = () => (
  <div className={`${styles.flexCenter} w-[120px] h-[120px] rounded-full bg-red-gradient p-[2px] cursor-pointer`}>
    <div className={`${styles.flexCenter} flex-col bg-red w-[100%] h-[100%] rounded-full`}>
      <div className={`${styles.flexStart} flex-row`}>
        <a href="https://wa.me/qr/EVTN2KLCPOA4J1" target="__blank" className="font-poppins font-medium text-[18px] leading-[23px] cursor-pointer mr-2">
