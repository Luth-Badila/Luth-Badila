...
const Stats = () => (
  <section className={`${styles.flexCenter} flex-row flex-wrap bg-red`}>
    {stats.map((stat) => (
      <div key={stat.id} className={`flex-1 flex justify-center items-center flex-row m-3 whitespace-none`}>
